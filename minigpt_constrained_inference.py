...
def parse_args():
    ...
    # parser.add_argument("--image_path", type=str, default='unconstrained_attack_images/adversarial_', help="Image file")
    ...
    parser.add_argument("--output_file", type=str, default='outputs/minigpt4/inference_unconstrained_attack',
                        help="Output file.")
...
if args.image_safety_patch is not None:
    ...
    safety_patch = None  # For baseline
