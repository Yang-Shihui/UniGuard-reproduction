...
class PerspectiveApiScorer:
    ...
    def __init__(self, api_key: str, http=None):
        ...
        :param http: optional httplib2.Http object with proxy configuration
        """
        build_params = {
        ...
        if http is not None:
            build_params['http'] = http
        
        self._service = discovery.build('commentanalyzer', 'v1alpha1', **build_params)
