...
def smooth(prompt, perturb_pct=0.05):
    ...
    smoothed = func(prompt, adaptive_pct)
    return smoothed


# # better examples should be used here
# sample_prompts = "Lorem ipsum dolor sit amet, consectetur adipiscing elit."

# result = smooth(sample_prompts, perturb_pct=0.1)
# print(result)